 ...
 */
const ENFORCED_PREFIXES = ['docs/shapes/', 'docs/select-and-transform/', 'docs/events/', 'docs/performance/', 'docs/drag-and-drop/', 'docs/styling/', 'docs/filters/', 'docs/tweens/', 'docs/animations/'];
